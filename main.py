...
if st.button("Get Recommendation"):
    ...
    # Add missing columns with default values to match training data
    for missing_feature in ["primary_storage_capacity", "secondary_storage_capacity", "year_of_warranty"]:
        input_df[missing_feature] = 0  # Default value
